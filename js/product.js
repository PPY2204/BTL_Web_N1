...
const productData = [
  ...
  },
  {
    ...
    productDescription: "Red Velvet Cake là một chiếc bánh độc đáo mà tất cả mọi người yêu thích. Lớp phủ kem phô mai thơm và ngọt ngào. Với kết cấu mềm mịn như nhung và lớp sương bông xốp",
    state: 1
  },
  {
  ...
  },
  {
    ...
    productDescription: "Bánh Sinh Nhật Tiramisu là một loại bánh ngọt tráng miệng vị cà phê của nước Ý, gồm các lớp bánh quy Savoiardi, nhúng cà phê xen kẽ với hỗn hợp trứng, đường, phô mai mascarpone đánh bông, thêm một ít bột cacao. Công thức bánh này được biến tấu thành nhiều món bánh và món tráng miệng khác nhau.",
    state: 0
  },
  {
